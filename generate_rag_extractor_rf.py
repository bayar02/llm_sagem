...
{
  "RF_Tests": [
    {"Test": "libelle du test tel qu\\'ecrit dans le document (ex: TX: MCS0 HT20, RX PER: LE 1M PRBS)",
...
def _extract_band_rag(pdf_path: str, product: str, band: str) -> List[dict]:
    passages = hybrid_search(query=BAND_QUERIES[band], product=product, top_k=8)
...
print("OK: rag_extractor_rf.py cree.")